...
#少量测试集上最好的
labels = ['black soil,its characteristics include deep black,highly fertile,strong expansion ability,contains organic matter', 'yellow soil,its characteristics include bright yellow,contains minerals', 'cinder soil,its characteristics include gray-black,contains cinder particles,loose texture', 'peat soil,its characteristics include brown or dark brown,contains large amounts of peat,rich in organic matter', 'laterite soil,its characteristics include red or orange-red']
# Initialize counters
match_count = 0
mismatch_count = 0
